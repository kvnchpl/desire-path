...
`encounters.json` and `distances.json` are generated public files. Do not edit them by hand. `feeling-distances.json`, `knowing-distances.json`, and `settings.json` are authored configuration and may be edited directly.
