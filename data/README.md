...
The fictional sample encounters collectively exercise every supported Place, Time, Feeling, and Knowing category. Placeholder records also cover text, image, audio, and video media so each display path can be tested before final material is supplied. Their temporary media files live in `assets/media/placeholders/`; final media should be grouped by encounter ID under `assets/media/`.
